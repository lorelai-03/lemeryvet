...
<head>
  ...
  <title>Veterinary Clinic Management System | Location Registration</title>
...
<div class="card mb-4 mx-3 mt-4">
    <div class="card-body">
        <div class="section-title">
            <h4 class="m-0 text-uppercase font-weight-bold">Veterinary Clinic Spatial Data Registration</h4>
        </div>
        <br>
<form id="clinicForm" enctype="multipart/form-data">
    <div class="form-group">
        <label for="business_permit_no">Business Permit No.</label>
        <input type="text" class="form-control" id="business_permit_no" name="business_permit_no" placeholder="Enter business permit number">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="line_of_business" name="line_of_business" placeholder="Enter line of business">
    </div>
    <div class="form-group">
...
<div class="form-group position-relative">
    <img id="clinic-img" src="https://www.w3schools.com/w3images/avatar5.png" alt="Clinic Picture" class="img-fluid">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status === 'success') {
                    showToast('Clinic information save successfully.','success');
