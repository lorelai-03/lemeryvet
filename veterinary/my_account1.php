...
try {
    ...
    $stmt = $pdo->prepare('SELECT email, password, vet_image FROM veterinarians WHERE email = :email');
...
$sourceDir = 'C:\\xampp\\htdocs\\lemeryvet\\veterinary\\uploads\\vet_images';
$destDir = 'C:\\xampp\\htdocs\\lemeryvet\\user\\uploads\\vet_images';
...
// Loop through files and copy them to the destination directory
foreach ($files as $file) {
    if ($file !== '.' && $file !== '..') {
        // Define full path for source and destination files
